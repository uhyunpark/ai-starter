...
- Activates: `layout-developer` skill
...
# Backend Services
services/src/**/*.ts         # Service files
api/src/**/*.ts              # API files
...
**Prisma Detection:**
- File contains: `import { PrismaService } from './prisma'`
